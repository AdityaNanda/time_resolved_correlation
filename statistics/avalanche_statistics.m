function [Fn,tau, Fl,alph, shape_cllps, avg_n_given_l, signuz_inv] = avalanche_statistics(v)
% AVALANCHE_STATISTICS          Compute avalanche statistics
%
%   Inputs
%           v   (n x t) LFP recording
%
%   Outputs
%           Fn              probability density function of avalanche sizes
%           tau             powerlaw exponent fit to Fn
%           Fl              probability density function of avalanche duration
%           alpha           power-law exponent fit to Fl
%           shape_cllps     cell array containing averaged avalanche shapes
%           avg_n_given_l   average avalanche size given a certain duration
%           signuz_inv      power-law exponent fit to avalanche duration and avg_n_given_l
